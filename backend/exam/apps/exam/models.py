...
class TblExam(models.Model):
    ...
    question_ids = models.CharField(max_length=256, blank=True, null=True, verbose_name='当前考试下的题目的id用-连在一起地字符串', help_text='当前考试下的题目的id用-连在一起地字符串')
    ...
    creator_id = models.CharField(max_length=32, verbose_name='考试创建者的用户id', help_text='考试创建者的用户id')
