...
class UserInfo(AbstractUser):
    ...
    phone = models.CharField(max_length=11, blank=True, null=True, verbose_name='手机号码', help_text='手机号码')
...
class TblRole(models.Model):
    role_id = models.AutoField(primary_key=True, verbose_name='角色ID', help_text='角色ID')
